...
import com.password.kg.passwordbook.helper.LanguageHelper;
...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private void attemptLogin() {
        ...
        if (cancel) {
            ...
            Call<AccessToken> call = authorization.getAccessToken("password", email, password);
            call.enqueue(new Callback<AccessToken>() {
                @Override
                public void onResponse(Response<AccessToken> response, Retrofit retrofit) {
                    if(response.isSuccess()){
                        user.setEmail(response.body().userName);
                        ...
                        AlertDialog.Builder builder = new AlertDialog.Builder(LoginActivity.this, R.style.CustomAlertDialogStyle);
                        builder.setTitle(getString(R.string.authorization))
                ...
                public void onFailure(Throwable t) {
                    ...
                    builder.setTitle(getString(R.string.connection))
                            .setMessage(getString(R.string.networkUnreachable))
